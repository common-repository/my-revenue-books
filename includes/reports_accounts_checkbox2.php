...
<form name="export" method="post" action="admin.php?page=my-revenue-books/myrevenuebooks_report_accounts.php&noheader=true">
...
<input type="hidden" name="the_business_name" value="Y">
<input type="hidden" name="the_post_id" value="<?php echo $the_id; ?>">
