...
<div id="mrb_wrapper">
	...
	<tr><td><span class="dashicons dashicons-chart-bar"></span> <b>Reports - Detailed Account</b></td></tr>
	</table>
	
	<table align="left" border="0" cellpadding="4" cellspacing="0" width="100%">
	
	<form name="display-submit" method="post">
	<tr bgcolor="#d2d2d2"><td align="center">Account: <select name="the_business_id" value="" style="font-size:12px">Select</option>";
...
$myrevenuebooks_sqlq = $wpdb->get_results($wpdb->prepare("SELECT * FROM " . $table . " WHERE business_id > %s AND business_name <> %s ORDER BY business_name ASC", $the_id, $the_bus_name ));
	...
	?>
	<option value="<?php echo $myrevenuebooks_sql->id; ?>"><?php echo $business_name; ?></option>
	<?php
	}
...
?>
	...
	<td>Filter Dates From: <input type="text" name="from_date" value="<?php echo htmlspecialchars($from_date); ?>" size="10" maxlength="50" id="datepicker" />
