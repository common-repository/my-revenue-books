...
<div id="mrb_invoice_wrapper">
	...
	<tr><td><h4><?php echo htmlspecialchars($business_name); ?></h4></td></tr>
	</table>
	</div>

	<div class="mrb_invoice_date_wrapper"><b>Invoice Date: </b><input type="text" value="<?php echo htmlspecialchars($the_date); ?>" name="the_date" size="20" maxlength="100" id="datepicker" /></div>
	<div class="mrb_invoice_date_wrapper"><b>Invoice or PO#: </b><input type="text" value="<?php echo htmlspecialchars($po_ref); ?>" name="po_ref" size="20" maxlength="100"/><br></div>
	<div class="mrb_invoice_date_wrapper"><b>Reference: </b><input type="text" value="<?php echo htmlspecialchars($the_ref); ?>" name="the_ref" size="20" maxlength="100"/></div>
	<div class="mrb_invoice_date_wrapper"><b>Due Date: </b><input type="text" value="<?php echo htmlspecialchars($due_date); ?>" name="due_date" size="20" maxlength="100" id="datepicker7" /></div>
	<div class="cb"></div>
...
<div class="mrb_invoice_body_wrapper">
	...
	<tr><td><input type="text" name="primary_contact" value="<?php echo htmlspecialchars($primary_contact); ?>" size="30" maxlength="200"></td>
		<td><input type="text" name="primary_email" value="<?php echo htmlspecialchars($primary_email); ?>" size="50" maxlength="200"></td>
		<td><input type="text" name="primary_notes" value="<?php echo htmlspecialchars($primary_notes); ?>" size="51" maxlength="200"></td></tr>
	</table>
	
	<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td>&nbsp;<b>Secondary Contact Name</b></td><td>&nbsp;<b>Secondary Contact Email</b></td><td>&nbsp;<b>Secondary Contact Notes</b></td></tr>
	<tr><td><input type="text" name="secondary_contact" value="<?php echo htmlspecialchars($secondary_contact); ?>" size="30" maxlength="200"></td>
		<td><input type="text" name="secondary_email" value="<?php echo htmlspecialchars($secondary_email); ?>" size="50" maxlength="200"></td>
		<td><input type="text" name="secondary_notes" value="<?php echo htmlspecialchars($secondary_notes); ?>" size="51" maxlength="200"></td></tr>
	</table>
</div>
...
<div class="mrb_invoice_body_wrapper">
	...
	<tr><td><input type="text" id="datepicker2" name="campain_start" value="<?php echo htmlspecialchars($campain_start); ?>" size="15" maxlength="100" placeholder="Start"></td>
		<td>to</td>
		<td><input type="text" id="datepicker3" name="campain_end" value="<?php echo htmlspecialchars($campain_end); ?>" size="15" maxlength="100" placeholder="End"></td>
		<td width="70px" align="left"><select name="reminder">
			<option value="<?php echo htmlspecialchars($reminder); ?>"><?php echo htmlspecialchars($reminder); ?></option>
			<option value="No">No</option>
 			<option value="Yes">Yes</option>
  			</select></td>
		<td align="left"><input type="text" id="datepicker4" name="reminder_date" value="<?php echo htmlspecialchars($reminder_date); ?>" size="15" maxlength="100" placeholder="If yes, add date"></td>
		<td width="70px"><select name="reminder_sent">
			<option value="<?php echo htmlspecialchars($reminder_sent); ?>"><?php echo htmlspecialchars($reminder_sent); ?></option>
			<option value="No">No</option>
    		<option value="Yes">Yes</option>
 			</select></td>
		<td><input type="text" id="datepicker5" name="reminder_date_sent" value="<?php echo htmlspecialchars($reminder_date_sent); ?>" size="15" maxlength="100" placeholder="If yes, add date"></td>
	</tr>
	</table>
	
	<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td align="left" width="110">&nbsp;<b>Duration Notes</b></td></tr>
	<tr><td><input type="text" name="duration" value="<?php echo htmlspecialchars($duration); ?>" size="148" maxlength="5000"></td></tr>
	</table>
</div>
...
<div class="mrb_ad_contact_email_wrapper">
	...
	<td>&nbsp;<?php echo "<a href='admin.php?page=my-revenue-books/myrevenuebooks_email_reminder.php&id=$the_id&b_id=$business_id'>Send A Email Reminder"; ?></a> &nbsp;&nbsp;*Set your default email template in <a href="admin.php?page=my-revenue-books/myrevenuebooks_settings.php">settings</a>.</td></tr>
	</table>
	
	<table align="left" border="0" cellpadding="2" cellspacing="0" width="100%">
	
<?php //Check for sent emails
$I=0;
$tbbg = "#ffffff";
	...
	$email_subject[$I] = $myrevenuebooks_sql->email_subject;
	echo "<tr bgcolor='$tbbg'><td valign='top' colspan='1' width='17%'>&nbsp;&nbsp;<span class='dashicons dashicons-arrow-right'></span> <a href='admin.php?page=my-revenue-books/myrevenuebooks_edit_transaction.php&get_id=$email_id[$I]&id=$email_the_id[$I]&b_id=$email_the_b_id[$I]'>$email_subject[$I]</a> ($email_reminder_date_sent[$I])</td></tr>";
		...
		if ($get_id <> 0) {
			...
			$reminder_sent2[$I] = $myrevenuebooks_sql2->reminder_sent;
			$reminder_date_sent2[$I] = $myrevenuebooks_sql2->reminder_date_sent;

?>
<tr><td align="right"><textarea style="width: 97%; max-width: 99.5%;" rows="8" name="mrb_show_email" maxlength="900000">
<?php
			echo "From (Name): " . $email_from_name[$I] . "\r\n";
			echo "From (Email Address): " . $email_from[$I] . "\r\n";
			echo "To: " . $email_to[$I] . "\r\n";
			echo "Cc: " . $email_to_cc[$I] . "\r\n";
			echo "Bcc: " . $email_to_bcc[$I] . "\r\n";
			echo "Subject: " . $email_subject[$I] . "\r\n";
			echo $email_body[$I] . "\r\n";
							}
		//echo "</tr>";
...
<!-- ///////////////////////// AD DETAILS ///////////////////////// -->
	<div class="mrb_invoice_header_wrapper">
	<span class="dashicons dashicons-clipboard"></span> <b>Post Ad Details:</b>
	</div>


<div class="mrb_invoice_body_wrapper">
	<table align="left" border="0" cellpadding="1" cellspacing="2" width="100%" bgcolor="#e7e7e7">
	<tr><td align="left" width="70"><b>Status:</b></td>
	<td align="left" width="110"><select name="ad_post_status">
	...
	<td width="70"><b>Post Term:</b></td><td width="110px"><input type="text" name="ad_post_term_year" size="3" maxlength="10" value="<?php echo htmlspecialchars($ad_post_term_year); ?>" placeholder="0"> Year(s)</td>
	...
	<td width="100px"><b>&nbsp;<font style="color:red">&#37; Plagiarism</font></b><input type="text" name="ad_post_plagiarism_plag" size="8" maxlength="20" value="<?php echo htmlspecialchars($ad_post_plagiarism_plag); ?>"></td>
	<td width="100px"><b>&nbsp;&nbsp;<font style="color:green">&#37; Unique</font></b><input type="text" name="ad_post_plagiarism_unique" size="8" maxlength="20" value="<?php echo htmlspecialchars($ad_post_plagiarism_unique); ?>"></td>
	</tr>
	</table>
...
<!-- ///////////////////////// AD DETAILS ///////////////////////// -->	
	...
	<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td width="100%"><span class="dashicons dashicons-open-folder"></span> <b>Description:</b><br><textarea style="width: 99.5%; max-width: 99.5%;" rows="8" name="description" maxlength="900000"><?php echo htmlspecialchars($description); ?></textarea></td></tr>
	<tr><td><span class="dashicons dashicons-html"></span> <b>HTML:</b><br><textarea style="width: 99.5%; max-width: 99.5%;" rows="8" name="ad_html" maxlength="900000"><?php echo htmlspecialchars($ad_html); ?></textarea></td></tr>
	<tr><td><span class="dashicons dashicons-media-text"></span> <b>Notes:</b><br><textarea style="width: 99.5%; max-width: 99.5%;" rows="8" name="notes" maxlength="900000"><?php echo htmlspecialchars($notes); ?></textarea></td></tr>
	<tr><td><span class="dashicons dashicons-media-text"></span> <b>Log Notes:</b><br><textarea style="width: 99.5%; max-width: 99.5%;" rows="8" name="log_notes" maxlength="900000"><?php echo htmlspecialchars($log_notes); ?></textarea></td></tr>
	<tr><td>&nbsp;</td></tr>
	</table>
	...
	<tr><td height="22px" colspan="2" align="center" style="vertical-align: middle;" >
		<div id="mrb_workorder_wrapper2"><font color="#000000"><b>------ &nbsp;W O R K O R D E R&nbsp;&nbsp;&nbsp;&nbsp;D E T A I L S&nbsp; ------</b></font></div></td></tr>
	</table>

	<!-- hidden values add-on -->
	...
	<! -- select a user -->
	<select name="workorder_assigned">
	...
	<tr bgcolor="#ffffff"><td width="115px" align="left"><font color="#068200"><b>Workorder Status:</b></font>&nbsp;</td>
		<td align="left"><select name="workorder_status" required>
	...
	<table align="left" border="0" cellpadding="4" cellspacing="0" width="99.5%">
		...
		<td align="left" width="95px"><select name="workorder_file_status" required>
	...
	<tr bgcolor="#ffffff"><td><input type="text" name="workorder_commission" placeholder="0.00" step="0.01" value="<?php echo htmlspecialchars($workorder_commission); ?>" size="7" maxlength="100"></td>
		<td><input type="text" value="<?php echo htmlspecialchars($workorder_due_date); ?>" name="workorder_due_date" size="10" maxlength="100" id="datepicker8"/></td>
		<td><input type="text" value="<?php echo htmlspecialchars($workorder_payment_date); ?>" name="workorder_payment_date" size="10" maxlength="100" id="datepicker9"/></td>
		<td><input type="text" value="<?php echo htmlspecialchars($workorder_payment_details); ?>" name="workorder_payment_details" size="90" maxlength="500"/></td></tr>
		</table>
	...
	?>
	<tr><td>
	<?php wp_editor( $default_content, $editor_id,array('workorder_details' => $option_name,'media_buttons' => false,'editor_height' => 150,'teeny' => true)  ); ?>
	</td></tr>
	</table>
...
<?php } //end workorder_type = Workorder ?>
...
<div class="mrb_invoice_body_wrapper">
	...
	<!-- <div class="mrb_desc_text"> -->
		...
		<tr><td><input type="text" name="payment_date" size="7" maxlength="100" placeholder="Date Rcvd" id="datepicker6" value="<?php echo htmlspecialchars($payment_date); ?>"></td>
			<td><input type="text" name="payment_type" size="10" maxlength="200" placeholder="Cash, Paypal, etc." value="<?php echo htmlspecialchars($payment_type); ?>"></td>
			<td><input type="text" name="payment_name" size="15" maxlength="100" placeholder="Sender name" value="<?php echo htmlspecialchars($payment_name); ?>"></td>
			<td><input type="text" name="payment_email" size="25" maxlength="200" placeholder="Sender email address" value="<?php echo htmlspecialchars($payment_email); ?>"></td>
			<td><input type="text" name="payment_transid" size="20" maxlength="100" placeholder="ID or number" value="<?php echo htmlspecialchars($payment_transid); ?>"></td>
		</tr>
		</table>
	<!-- </div> -->
	...
	<!-- <div class="mrb_desc_text"> -->
		...
		<tr><td><input type="text" name="payment_link" size="111" maxlength="300" value="<?php echo htmlspecialchars($payment_link); ?>"></td></tr>
		<tr><td><b>Payment Details:</b></td></tr>
		<tr><td><textarea rows="16" cols="114" name="payment_details" maxlength="5000" placeholder="Add any additional ad, payment, or transaction details here."><?php echo htmlspecialchars($payment_details); ?></textarea></td></tr>
		</table>
	<!-- </div> -->
</div>
...
<div class="mrb_desc_text_wrapper2">
	...
	<div class="mrb_desc_text">
		...
		<tr><td><b>$</b><input type="number" id="subtotal" name="subtotal" value="<?php echo htmlspecialchars($subtotal); ?>" size="7" maxlength="20" placeholder="0.00" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onchange="mrbcalc(this)" class="pmtsize" required></td></tr>
		</table>
	</div>
</div>
...
<div class="mrb_desc_text_wrapper3">
	<div class="mrb_desc_text">
		...
		<tr><td><b>$</b><input type="number" id="discount" name="discount" value="<?php echo htmlspecialchars($discount); ?>" size="7" maxlength="20" placeholder="0.00" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onchange="mrbcalc(this)" class="pmtsize" required></td></tr>
		</table>
	</div>
	...
	<div class="mrb_desc_text">
		...
		<tr><td><b>$</b><input type="number" id="shipping" name="shipping" value="<?php echo htmlspecialchars($shipping); ?>" size="7" maxlength="20" placeholder="0.00" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onchange="mrbcalc(this)" class="pmtsize" required></td></tr>
		</table>
	</div>
	...
	<div class="mrb_desc_text">
		...
		<tr><td><b>$</b><input type="number" id="additional" name="additional" value="<?php echo htmlspecialchars($additional); ?>" size="7" maxlength="20" placeholder="0.00" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onchange="mrbcalc(this)" class="pmtsize" required></td></tr>
		</table>
	</div>
	...
	<div class="mrb_desc_text">
		...
		<tr><td><b>$</b><input type="number" id="fee" name="fee" value="<?php echo htmlspecialchars($fee); ?>" size="7" maxlength="20" placeholder="0.00" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onchange="mrbcalc(this)" class="pmtsize" required></td></tr>
		</table>
	</div>
	...
	<div class="mrb_desc_text">
		...
		<tr><td><b>$</b><input type="number" id="tax" name="tax" value="<?php echo htmlspecialchars($tax); ?>" size="7" maxlength="20" placeholder="0.00" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onchange="mrbcalc(this)" class="pmtsize" required></td></tr>
		</table>
	</div>
</div>
...
<div class="mrb_desc_text_wrapper4">
	<div class="mrb_desc_text">
		...
		<tr><td>
    		...
    		<?php if ($status <> "Net10") {?> <option value="Net10">Net10</option><?php } ?>
    		<?php if ($status <> "Net15") {?> <option value="Net15">Net15</option><?php } ?>
    		<?php if ($status <> "Net20") {?> <option value="Net20">Net20</option><?php } ?>
    		<?php if ($status <> "Net30") {?> <option value="Net30">Net30</option><?php } ?>
    		<?php if ($status <> "Net45") {?> <option value="Net45">Net45</option><?php } ?>
    		<?php if ($status <> "Net60") {?> <option value="Net60">Net60</option><?php } ?>
    		<?php if ($status <> "Other") {?> <option value="Other">Other</option><?php } ?>
    		<?php if ($status <> "Workorder") {?> <option value="Workorder">Workorder</option><?php } ?>
 			</select>
		</td>
