...
<div id="mrb_links_wrapper">
	<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr><td>&nbsp;</td></tr>
	<tr><td align="left"><span class="dashicons dashicons-search"></span>&nbsp;<b>Search</b> - <i>Post links can be searched by using the <a href="admin.php?page=my-revenue-books/myrevenuebooks_link_report.php">link report</a> page.</i></td></tr>
	</table>
</div>
...
<table align="left" border="0" cellpadding="4" cellspacing="0" width="100%">
	...
	<tr><td align="left"><input class="mrb_search_textbox" type="text" placeholder="Search (case-sensitive)" name="my_search" value="" size="90" maxlength="500" required>
...
<tr class="mrb_heading_text">
	<td width='40px'><div class="mrb_sort">ID <a href='admin.php?page=my-revenue-books/myrevenuebooks_search.php&my_search=<?php echo $my_search; ?>&mrb_sort=<?php echo $mrb_sort1; ?>'><span class="dashicons dashicons-sort"></span></a></div></td>
	<td align='left'><div class="mrb_sort">DATE <a href='admin.php?page=my-revenue-books/myrevenuebooks_search.php&my_search=<?php echo $my_search; ?>&mrb_sort=<?php echo $mrb_sort2; ?>'><span class="dashicons dashicons-sort"></span></a></div></td>
...
<?php
	...
	//$myrevenuebooks_sqlq = $wpdb->get_results($wpdb->prepare("SELECT * FROM " . $table . " WHERE id <> %s AND business_id <> %s ORDER BY $mrb_sort LIMIT $offset, $mrb_limit", $default_id, $the_b_id ));
