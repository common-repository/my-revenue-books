...
$FileName = "mrb_transaction_report.csv";
...
include ("includes/reports_checkbox.php");
...
<div id="mrb_wrapper2">
	...
	<?php include ("includes/reports_checkbox2.php"); ?>
...
//$business_name_print = wp_trim_words( $business_name, $num_words = 4, $more = '… ' );
